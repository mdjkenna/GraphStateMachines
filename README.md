...
### [Defining a State Machine](./docs/defining-a-state-machine.md)

Learn how to define states, vertices, and edges using the graph builder DSL.

---

### [Walkers and Traversers: Use Cases](./docs/walkers-and-traversers.md)

Understand the differences between Traversers and Walkers, their use cases, and when to use each.

---

### [Observing State Changes](./docs/observing-state-changes.md)

Learn how to observe state changes using `StateFlow` and integrate with Kotlin coroutines.

---

### [Actions and Transitions](./docs/actions-and-navigation.md)

Dispatch actions to control state transitions, including basic actions and actions with arguments.

---

### [Transition Guards and Guard State](./docs/transition-guards.md)

Dynamically constrain transitions using transition guards and manage shared guard state.

---

### [Handling Before Incoming and Outgoing Transitions](./docs/handlers.md)

Execute custom logic at specific points during state transitions using handlers.

---

### [Intermediate States](./docs/intermediate-states.md)

Represent side effects as explicit states within the graph model.

---

### [Using Cycles](./docs/cycles.md)

Implement cyclic graphs and manage infinite loops using transition guards.

---

### [Concurrency](./docs/concurrency.md)

Understand the actor model, single-threaded execution, and coroutine scope configuration.

---

### [Destructuring](./docs/destructuring.md)

Separate state observation from action dispatching using Kotlin destructuring syntax.

---

### [Visualising State Machines](./docs/visualization.md)

Generate DOT language representations and visualize state machines.
